...
import { Sprout, Mail, Lock, ArrowRight, Github, Chrome } from 'lucide-react';
    ...
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-serif font-bold text-text-main">Welcome Back</h1>
        ...
        <p className="text-center mt-8 text-sm text-text-muted">
          ...
          <Link to="/signup" className="font-bold text-primary hover:underline">Create an account</Link>
        </p>
      </div>
    </motion.div>
  );
